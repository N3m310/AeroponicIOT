...
namespace AeroponicIOT.Migrations
{
    ...
    [Migration("20260702040844_AddGardenManyToManyOwners")]
    partial class AddGardenManyToManyOwners
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("user_gardens", b =>
                {
                    ...
                    b.HasKey("garden_id", "user_id");

                    b.HasIndex("user_id");

                    b.ToTable("user_gardens");
                });
            ...
            modelBuilder.Entity("AeroponicIOT.Models.Garden", b =>
                {
                    b.HasOne("AeroponicIOT.Models.Crop", "CurrentCrop")
                        .WithMany()
                        .HasForeignKey("CurrentCropId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("user_gardens", b =>
                {
                    b.HasOne("AeroponicIOT.Models.Garden", null)
                        .WithMany()
                        .HasForeignKey("garden_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AeroponicIOT.Models.User", null)
                        .WithMany()
